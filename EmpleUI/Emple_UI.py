...
hot_drinks=Button(f2,image = hdrinks, text = "Hot drinks", fg = bar_color, font = "Arial 16", compound=CENTER, command=lambda:raise_frame(f6))
hot_drinks['border']='0'
hot_drinks_window = C.create_window(0, 62, anchor='nw', window=hot_drinks)

#Soft drinks
sdrinks=PhotoImage(file='Soft_drinks.png')
soft_drinks=Button(f2,image = sdrinks, text = "Soft drinks", fg = bar_color, font = "Arial 16", compound=CENTER, command=lambda:raise_frame(f6))
...
beer_drinks=Button(f2,image = bdrinks, text = "Beer", fg = bar_color, font = "Arial 16", compound=CENTER, command=lambda:raise_frame(f6))
...
alcohol_drinks=Button(f2,image = aldrinks, text = "Alcohol drinks", fg = bar_color, font = "Arial 16", compound=CENTER, command=lambda:raise_frame(f6))
...
wine_drinks=Button(f2,image = wdrinks, text = "Wine", fg = bar_color, font = "Arial 16", compound=CENTER, command=lambda:raise_frame(f4))
...
#Status bar
status_label_f3 = Label(f3, text = "Choose a category", fg = "white", font = myFont, bg = bar_color, compound=LEFT)
status_label_f3['width'] = '36'
status_label_f3['height'] = '2'
label_button_window_f3 = C3.create_window(0, 0, anchor='nw', window=status_label_f3)


#Back button
bckbutton2_f3 = PhotoImage(file = "back_button2.png")
...
pizza_food=Button(f3,image = pizza_f3, text = "Pizza", fg = bar_color, font = "Arial 16", compound=CENTER, command=lambda:raise_frame(f6))
pizza_food['border']='0'
...
pasta_food=Button(f3,image = pasta_f3, text = "Pasta", fg = bar_color, font = "Arial 16", compound=CENTER, command=lambda:raise_frame(f6))
pasta_food['border']='0'
pasta_food_window = C3.create_window(0, 148, anchor='nw', window=pasta_food)

#Salad
salad_f3 = PhotoImage(file = "salad.png")
salad_food=Button(f3,image = salad_f3, text = "Salad", fg = bar_color, font = "Arial 16", compound=CENTER, command=lambda:raise_frame(f6))
salad_food['border']='0'
salad_food_window = C3.create_window(0, 234, anchor='nw', window=salad_food)

#Soups
soups_f3 = PhotoImage(file = "soups.png")
soups_food=Button(f3,image = soups_f3, text = "Soups", fg = bar_color, font = "Arial 16", compound=CENTER, command=lambda:raise_frame(f6))
soups_food['border']='0'
soups_food_window = C3.create_window(0, 320, anchor='nw', window=soups_food)

#Desserts
deserts_f3 = PhotoImage(file = "Deserts.png")
desserts_food=Button(f3,image = deserts_f3, text = "Desserts", fg = bar_color, font = "Arial 16", compound=CENTER, command=lambda:raise_frame(f6))
...
grilled_food=Button(f3,image = grilled_f3, text = "Grilled", fg = bar_color, font = "Arial 16", compound=CENTER, command=lambda:raise_frame(f6))
...
#Text label
T = Text(f5, height = 5, width = 40, bg = "bisque", fg = "brown", font = "MSSansSerif 14 italic", borderwidth=0)
text_button_window_f5 = C5.create_window(80, 150, anchor='nw', window=T)
...
#Waiter button
waiterimg = PhotoImage(file = "waiter.png")
wtr_f6 = Button(f6, image = waiterimg, compound=CENTER, borderwidth=0, highlightthickness=0, border=0) 
wtr_button_window_f6 = C6.create_window(150, 280, anchor='nw', window=wtr_f6)
