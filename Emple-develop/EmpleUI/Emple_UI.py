...
bll_button_window_f4 = C4.create_window(130, 260, anchor='nw', window=bll_f4)
...
wtr_f6 = Button(f6, image = waiterimg, compound=CENTER, borderwidth=0, highlightthickness=0, border=0, command=lambda:raise_frame(f1)) 
wtr_button_window_f6 = C6.create_window(130, 260, anchor='nw', window=wtr_f6)
